  ...
  return (
    <GridBackgroundDemo>
      <main className="relative min-h-screen w-full">
        {/* HERO */}
        <div className="flex flex-col items-center pt-32 pb-2 px-2">
          ...
          <p className="mt-6 text-lg text-neutral-400 text-center max-w-3xl">
            Stunning UI components crafted for developers who care about design
            and performance.
          </p>

          <div className="relative w-full max-w-5xl mx-auto h-10 overflow-hidden mt-2 mb-4">
